...
public class FeedStreamLayout extends RelativeLayout {
    ...
    private FeedStreamListView listView;
    ...
    public FeedStreamLayout(Context context) {
        super(context);
    ...
    public FeedStreamLayout(Context context, AttributeSet attrs) {
    ...
    public FeedStreamLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        listView = (FeedStreamListView) this.getChildAt(2);
