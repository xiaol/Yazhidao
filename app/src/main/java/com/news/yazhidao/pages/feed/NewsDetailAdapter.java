        ...
        if (position == mSectionArr.size()) {
            ...
            praise.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (isPraise) {
                        mNewsDetailPraiseImg.setImageResource(R.drawable.ic_news_list_table_detail_unpraised);
                        ...
                        mNewsDetailPraiseImg.setImageResource(R.drawable.ic_news_list_table_detail_praised);
                        mNewsDetailPraiseTv.setText((TextUtil.parsePraiseNumber(mNewsDetailPraiseTv.getText().toString()) + 1) + "人热赞");
                        isPraise = true;
                        //TODO 向后台取消点赞
