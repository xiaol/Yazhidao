 ...
 */
public class GuidePageAty extends Activity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_guidepage);
        ...
        int[] imageResIDs = {
                R.drawable.ic_guide_page1,
                R.drawable.ic_guide_page2,
        };
            ...
            image.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (previousEnabledPosition == 1) {
                        ...
                        Intent intent = new Intent(GuidePageAty.this, UserLoginAty.class);
