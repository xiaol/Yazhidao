...
public class SettingFgt extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container,@Nullable Bundle savedInstanceState) {
        View view = View.inflate(this.getActivity(), R.layout.fgt_setting, null);
        ...
        iv_push.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pushflag) {
                    iv_push.setBackgroundResource(R.drawable.btn_setting_switch_close);
                    pushflag = false;
                }else{
                    iv_push.setBackgroundResource(R.drawable.btn_setting_switch_open);
                    pushflag = true;
                }
            }
        });
        ...
        iv_wifi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(wififag) {
                    iv_wifi.setBackgroundResource(R.drawable.btn_setting_switch_close);
                    wififag = false;
                }else{
                    iv_wifi.setBackgroundResource(R.drawable.btn_setting_switch_open);
                    wififag = true;
                }
            }
        });
